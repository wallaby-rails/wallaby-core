...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "pictures", force: :cascade do |t|
    ...
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
    t.index %w[imageable_type imageable_id], name: "index_pictures_on_imageable_type_and_imageable_id", using: :btree
  end
  ...
  create_table "products_tags", id: false, force: :cascade do |t|
    ...
    t.index %w[product_id tag_id], name: "index_products_tags_on_product_id_and_tag_id", unique: true, using: :btree
