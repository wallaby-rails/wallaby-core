...
describe Wallaby::Engine::AuthorizerGenerator, 'with a name', type: :generator do # rubocop:disable RSpec/DescribeMethod
...
describe Wallaby::Engine::AuthorizerGenerator, 'with name and parent', type: :generator do # rubocop:disable RSpec/DescribeMethod
  destination File.expand_path('../../../../tmp', __dir__)
