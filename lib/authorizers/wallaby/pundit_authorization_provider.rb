...
module Wallaby
  ...
  class PunditAuthorizationProvider < ModelAuthorizationProvider
    ...
    def authorize(action, subject)
      ...
      Rails.logger.info Wallaby.t('errors.unauthorized', user: user, action: action, subject: subject)
      raise Forbidden
    end
    ...
    def attributes_for(action, subject)
      ...
      Rails.logger.warn Wallaby.t('error.pundit.not_found.attributes_for', subject: subject) unless value
      value || {}
    end
